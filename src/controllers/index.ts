...
import { createCategoryController, readCategoryController,readAllRealEstateController } from "./category.controller";
...
export {
    ...
    createScheduleController,readScheduleController,readAllRealEstateController
}