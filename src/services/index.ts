...
import { createCategoryService,readCategoryService,readAllRealEstateService } from "./categories.service";
...
export {
    ...
    createScheduleService,readScheduleService,readAllRealEstateService
}